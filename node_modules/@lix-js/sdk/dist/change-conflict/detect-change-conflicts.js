...
export async function detectChangeConflicts(args) {
    ...
    const groupedByEntity = Object.groupBy(args.changes, (change) => `${change.entity_id}_${change.file_id}_${change.schema_key}`);
...
//# sourceMappingURL=detect-change-conflicts.js.map