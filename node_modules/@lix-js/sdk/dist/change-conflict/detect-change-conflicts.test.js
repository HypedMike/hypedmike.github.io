...
test("should detect conflicts using plugins", async () => {
    ...
    expect(detectedConflicts[0]?.conflictingChangeIds).toEqual(new Set(["change0", "change1"]));
...
test("should handle multiple plugins detecting conflicts", async () => {
    ...
    expect(detectedConflicts[1]?.conflictingChangeIds).toEqual(new Set(["change1", "change2"]));
...
test("it should auto detect diverging entity conflicts", async () => {
    ...
    expect(detectedConflicts[0]?.conflictingChangeIds).toEqual(new Set(["change1", "change2"]));
});
//# sourceMappingURL=detect-change-conflicts.test.js.map