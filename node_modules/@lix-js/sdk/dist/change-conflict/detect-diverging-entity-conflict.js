...
export const LIX_DIVERGING_ENTITY_CONFLICT_KEY = "lix-diverging-entity-conflict";
/**
...
export async function detectDivergingEntityConflict(args) {
    ...
    for (let i = 0; i < args.changes.length; i++) {
        for (let j = i + 1; j < args.changes.length; j++) {
            ...
            if (changeA.entity_id !== changeB.entity_id ||
            ...
            if (changeA.id === lowestCommonAncestor?.id ||
...
//# sourceMappingURL=detect-diverging-entity-conflict.js.map