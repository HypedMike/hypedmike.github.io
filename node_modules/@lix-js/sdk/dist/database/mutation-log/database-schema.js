export const tablesByDepencies = [
    // no dependencies
    "snapshot",
    "label",
    "version",
...
export function applyMutationLogDatabaseSchema(sqlite) {
...
function toSqliteJson(keyColumns) {
    if (keyColumns.length === 0) {
        throw new Error("Key columns array cannot be empty.");
    }
    const jsonObjectArgs = keyColumns.map((keyColumnName) => `'${keyColumnName}', NEW.${keyColumnName}`);
