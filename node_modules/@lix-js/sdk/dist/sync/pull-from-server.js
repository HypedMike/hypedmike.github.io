...
export async function pullFromServer(args) {
    ...
    const response = await fetch(new Request(`${args.serverUrl}/lsp/pull-v1`, {
        method: "POST",
        body: JSON.stringify({
            lix_id: args.id,
    ...
    const sessionStateServer = body.vector_clock;
...
//# sourceMappingURL=pull-from-server.js.map