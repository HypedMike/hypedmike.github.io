 ...
 *   ```
 */
export function changeSetElementInSymmetricDifference(a, b) {
    return (eb) => eb.or([
        eb("change_set_element.change_id", "in", (subquery) => subquery
            .selectFrom("change_set_element as A")
            .leftJoin("change_set_element as B", (join) => join
        ...
        eb("change_set_element.change_id", "in", (subquery) => subquery
            ...
            .leftJoin("change_set_element as A", (join) => join
...
//# sourceMappingURL=change-set-element-in-symmetric-difference.js.map