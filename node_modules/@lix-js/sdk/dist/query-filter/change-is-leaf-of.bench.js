...
import { newLixFile, openLixInMemory, } from "../index.js";
import { changeIsLeafOf } from "./change-is-leaf-of.js";
const createChange = (schema_key, payload, parentChangeId) => {
...
const setupLix = async (nMessages) => {
    ...
    for (let i = 0; i < nMessages; i++) {
        ...
        // -> 6 changes
        let lastMessageChangeId = null;
        for (let i = 0; i < 6; i++) {
            const changeAndSnapshot = createChange("message", payloads, lastMessageChangeId);
        ...
        let lastVariantChangeId = null;
        for (let i = 0; i < 100; i++) {
            const changeAndSnapshot = createChange("variant", payloads, lastVariantChangeId);
            mockChanges.push(changeAndSnapshot);
...
//# sourceMappingURL=change-is-leaf-of.bench.js.map