...
class AggregateFunctionBuilder {
    ...
    orderBy(orderBy, direction) {
        return new AggregateFunctionBuilder({
            ...this.#props,
            aggregateFunctionNode: aggregate_function_node_js_1.AggregateFunctionNode.cloneWithOrderBy(this.#props.aggregateFunctionNode, (0, order_by_parser_js_1.parseOrderBy)([orderBy, direction])),
        });
    }
    filterWhere(...args) {
        return new AggregateFunctionBuilder({
